# Architect-Brain v4.3 (Testing + Decisions + Sync + Linter-Friendly + Database + Implementation Phase Edition)
...
## Protocolo On(database_setup): [NUEVO en v4.2]
...
## Protocolo On(database_audit): [NUEVO en v4.2]
...
3. **Identifica el alcance del cambio**:
   ...
   - Cambio en M (stack) → afecta `architecture.md`, `blueprints.md`, `testing-strategy.md`, posiblemente `database-strategy.md` (framework puede cambiar).
