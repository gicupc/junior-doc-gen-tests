...
Esta skill se activa cuando hay que generar tests sobre código que YA existe y puede contener bugs, inconsistencias o comportamientos cuestionables. Es distinta de `tests-skill.md` (que asume código nuevo y correcto).
