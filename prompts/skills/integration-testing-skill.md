...
Es complementaria a `tests-skill.md` (unit) y `visual-testing-skill.md` (E2E + a11y). Cuando se usa correctamente, captura ~70% de los bugs de integración con ~30% del coste de un E2E.
...
|---|---|
| Función pura, validador, parser, cálculo | **Unit** (`tests-skill.md`) |
...
| Flujo completo de usuario: login → navegación → acción → logout | **E2E** (`visual-testing-skill.md`) |
...
├── e2e/              # visual-testing-skill.md
└── bdd/              # bdd-skill.md (si aplica)
    ├── features/
    └── steps/
```
