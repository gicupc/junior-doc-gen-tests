...
4. Segun la eleccion:
   ...
   **Si elige [4] Regularizar + Cubrir con tests + Auditar BD:**
   ...
   - **Si detectas codigo legacy sospechoso o divergencias con contrato formal, carga ADICIONALMENTE `@prompts/skills/legacy-testing-skill.md`** para distinguir SPEC vs CHARACTERIZATION en los tests generados.
   ...
   - **Si el proyecto tiene base de datos**, ejecuta tambien `On(database_audit)`:
     - Carga `@prompts/skills/database-skill.md`.
