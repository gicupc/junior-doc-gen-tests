---
description: Briefing rapido del estado del proyecto - "que hacemos hoy"
---
...
1. Lee en este orden: `docs/prd.md` (solo el objetivo), `docs/roadmap.md` completo, `docs/decisions-log.md` (ultimas 3 entradas), `docs/testing-strategy.md` (estado de cobertura).
