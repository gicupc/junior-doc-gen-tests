---
description: Mapa rapido de un codebase desconocido sin generar docs ni tocar nada
---
...
1. Carga `@prompts/skills/prompt-skill.md` para recordar el patron RACEO de respuesta.
