...
Cargar `prompts/skills/supply-chain-skill.md` como guía obligatoria para criterios de auditoría.
...
Si encuentras coincidencias: **severidad crítica + ticket urgente en roadmap + protocolo de respuesta a incidente** (ver `supply-chain-skill.md` sección "Respuesta a incidente").
