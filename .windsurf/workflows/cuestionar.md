---
description: Cuestionar la calidad real de los tests existentes - mutation thinking + sugerencias
---

# /cuestionar — Cuestionar la calidad de los tests

Este comando NO instala herramientas ni ejecuta mutation testing automáticamente. Plantea mentalmente mutaciones sobre el codigo y detecta falsa confianza en la suite actual.
