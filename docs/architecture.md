...
- **Interfaz:** Windsurf operando bajo el protocolo `@.windsurfrules`.
...
- **Dynamic Skills:** La IA genera archivos en `@prompts/skills/` para lógicas complejas (ej. Reglas fiscales, APIs externas, procesos SFTP).
